  ...
  return (
    ...
    >
      {currentLocation.pathname === "/RR" ? (
        <>
          <p style={{ marginBottom: "8px" }}>Tiempo encendido: {tEncendidoRR(dataProccesada[0]).toFixed(2)}</p>
          <p style={{ marginBottom: "8px" }}>Tiempo procesos: {tProcesosRR(dataProccesada[0]).toFixed(2)}</p>
          <p style={{ marginBottom: "8px" }}>Tiempo sistema: {tsistemaRR(dataProccesada[0]).toFixed(2)}</p>
          <p style={{ marginBottom: "8px" }}>%CPU Procesos: {porProcesos(dataProccesada[0]).toFixed(2)}</p>
          <p style={{ marginBottom: "8px" }}>%CPU sistemas: {porSistema(dataProccesada[0]).toFixed(2)}</p>
          <p style={{ marginBottom: "8px" }}>Promedio Retorno: {promedioRetorno(dataProccesada[1]).toFixed(2)}</p>
          <p style={{ marginBottom: "8px" }}>Promedio Tiempo Perdido: {promedioTPerdido(dataProccesada[1]).toFixed(2)}</p>
          <p style={{ marginBottom: "8px" }}>Promedio Espera: {promedioEspera(dataProccesada[1]).toFixed(2)}</p>
          <p style={{ marginBottom: "8px" }}>Promedio Ejecución: {promedioEjecucion(dataProccesada[1]).toFixed(2)}</p>
        </>
      ) : (
        <>
          <p style={{ marginBottom: "8px" }}>Tiempo Encendido: {tiempoEncendido(dataProccesada).toFixed(2)}</p>
          <p style={{ marginBottom: "8px" }}>Tiempo CPU: {tiempoCPU(dataProccesada).toFixed(2)}</p>
          <p style={{ marginBottom: "8px" }}>CPU Libre: {CPULibre(dataProccesada).toFixed(2)}</p>
          <p style={{ marginBottom: "8px" }}>Promedio Retorno: {promedioRetorno(dataProccesada).toFixed(2)}</p>
          <p style={{ marginBottom: "8px" }}>Promedio Tiempo Perdido: {promedioTPerdido(dataProccesada).toFixed(2)}</p>
          <p style={{ marginBottom: "8px" }}>Promedio Espera: {promedioEspera(dataProccesada).toFixed(2)}</p>
          <p style={{ marginBottom: "8px" }}>Promedio Ejecución: {promedioEjecucion(dataProccesada).toFixed(2)}</p>
        </>
      )}
    </div>
  );
